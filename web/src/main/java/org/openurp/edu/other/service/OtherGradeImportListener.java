...
public class OtherGradeImportListener extends ItemImporterListener {
  ...
  public OtherGradeImportListener(EntityDao entityDao, Project project, GradeRateService gradeRateService) {
    super();
  ...
  public void onItemStart(TransferResult tr) {
    ...
    List<OtherGrade> otherGrades = entityDao.search(builder);
  ...
  public void onItemFinish(TransferResult tr) {
    ...
    OtherGrade otherGrade = (OtherGrade) datas.get("otherGrade");
...
//      otherGrade.setUpdatedAt(new Date(System.currentTimeMillis()));
  ...
  private boolean otherGradeVilidate(OtherGrade otherGrade, TransferResult tr) {
    boolean bool = true;
    // 验证学号
