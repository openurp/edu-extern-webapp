...
public class OtherExamFeeConfigServiceImpl extends BaseServiceImpl implements OtherExamFeeConfigService {

  public List<OtherExamFeeConfig> getConfigs(Project project, Semester... semesters) {
    OqlBuilder<OtherExamFeeConfig> builder = OqlBuilder.from(OtherExamFeeConfig.class, "config");
