...
[@b.form name="otherExamSignUpForm" action="!save"  theme="list"]
    ...
    --]
    [@b.select name="otherExamSignUp.subject.id" items=otherExternExamSubjects empty="..." value=(otherExamSignUp.subject.id)! label="报名科目" style="width:150px" required="true"/]
