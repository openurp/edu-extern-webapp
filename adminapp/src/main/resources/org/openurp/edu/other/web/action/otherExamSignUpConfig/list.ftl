    ...
    [@b.grid items=otherExamSignUpConfigs var="otherExamSignUpConfig"]
        ...
        [@b.row]
            ...
            [@b.col property="name" title="开关名称"]
                [@b.a title="查看详细信息" href="otherExamSignUpConfig!info?otherExamSignUpConfig.id=${(otherExamSignUpConfig.id)!}"]${(otherExamSignUpConfig.name)!}[/@]
            [/@]
...
<script>
    function editSetting(){
        ...
        bg.form.submit(document.otherExamSignUpConfigListForm,"otherExamSignUpSetting!search.action");
    }
</script>
[@b.foot/]