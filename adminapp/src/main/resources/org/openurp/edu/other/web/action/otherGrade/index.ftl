...
<div>
    ...
    <tr>
        <td class="index_view">
            ...
            [@b.form name="importForm" action="otherGrade!importForm" target="otherGradeList"/]
        </td>
...
<script>
    ...
    function changeSubjects(){
        var res = jQuery.post("${base}/otherGrade!categorySubject.action",{categoryId:jQuery("#categoryId").val()},function(){
            if(res.status==200){
