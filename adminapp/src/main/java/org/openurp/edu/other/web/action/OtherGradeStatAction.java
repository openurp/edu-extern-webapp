 ...
 * @author chaostone
 */
public class OtherGradeStatAction extends RestrictionSupportAction {
  ...
  public String statGrade() {
    ...
    List<OtherExamCategory> categories = CollectUtils.newArrayList();
    ...
    if (null != subjectId) {
      ...
      OqlBuilder<OtherExamSubject> subjectquery = OqlBuilder.from(OtherExamSubject.class, "subject");
      // OqlBuilder categoryQuery = OqlBuilder.from(OtherExamCategory.class, "category");
    ...
    new StatHelper(entityDao).replaceIdWith(data2, new Class[] { Department.class, OtherExamCategory.class });
