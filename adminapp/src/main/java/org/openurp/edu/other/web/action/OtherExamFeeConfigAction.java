...
public class OtherExamFeeConfigAction extends SemesterSupportAction {

  protected OtherExamFeeConfigService otherExamFeeConfigService;

  @Override
  protected String getEntityName() {
    return OtherExamFeeConfig.class.getName();
  }
  ...
  protected String saveAndForward(Entity<?> entity) {
    OtherExamFeeConfig config = (OtherExamFeeConfig) entity;
    if (config.isTransient()) {
      OtherExamFeeConfig persistedConfig = otherExamFeeConfigService.getConfig(config);
